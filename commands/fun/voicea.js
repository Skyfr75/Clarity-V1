...
module.exports = {
    name: "voicea",
    aliases:["voiceactivities"],
    description:"permet aux utilisateurs de démarrer différentes activités vocales à l\'intérieur d\'un salon vocal.",
    run: async(client, message, args, prefix) => {
        ...
        const base = new Discord.MessageActionRow()
            ...
            .setColor(color)
            .setDescription(`
**Activité vocal !** Veuillez choisir une option d'activié via le SelectMennu ci-dessous !
`)
            .setFooter({ text: `Clarity ${client.config.version} | Prefix actuel : ${prefix}` })
